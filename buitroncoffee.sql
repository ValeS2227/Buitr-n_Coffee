...
-- (Agregado para el módulo de mapa de puntos de recogida)
--

CREATE TABLE `puntos_recogida` (
  `ID_Punto` int(11) NOT NULL COMMENT 'Identificador único del punto de recogida',
  `nombre` varchar(100) NOT NULL COMMENT 'Nombre del punto de recogida',
  `direccion` varchar(200) NOT NULL COMMENT 'Dirección completa del punto',
  `lat` decimal(10,7) NOT NULL COMMENT 'Latitud para el mapa',
  `lng` decimal(10,7) NOT NULL COMMENT 'Longitud para el mapa',
  `horario` varchar(150) DEFAULT NULL COMMENT 'Horario de atención',
  `telefono` varchar(20) DEFAULT NULL COMMENT 'Teléfono de contacto',
  `estado` enum('abierto','ocupado','cerrado') DEFAULT 'abierto' COMMENT 'Estado actual del punto'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Puntos de recogida de café en el mapa';

--
-- Volcado de datos de ejemplo para `puntos_recogida`
--

INSERT INTO `puntos_recogida` (`ID_Punto`, `nombre`, `direccion`, `lat`, `lng`, `horario`, `telefono`, `estado`) VALUES
(1, 'Sede Principal Pitalito', 'Calle 5 #4-23, Pitalito, Huila', 1.8561200, -76.0511400, 'Lun-Vie 8:00-18:00 | Sáb 8:00-13:00', '320 123 4567', 'abierto'),
(2, 'Punto Centro Neiva', 'Carrera 6 #7-15, Neiva, Huila', 2.9273300, -75.2819200, 'Lun-Sáb 9:00-17:00', '320 987 6543', 'abierto'),
(3, 'Punto Bogotá Norte', 'Av. 19 #118-30, Bogotá D.C.', 4.7219100, -74.0429300, 'Lun-Vie 9:00-19:00 | Sáb 10:00-15:00', '321 456 7890', 'ocupado'),
(4, 'Punto Medellín El Poblado', 'Calle 9 #38-10, El Poblado, Medellín', 6.2017700, -75.5696900, 'Mar-Dom 9:00-18:00', '322 111 2222', 'cerrado');
