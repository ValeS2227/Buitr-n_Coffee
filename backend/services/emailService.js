        ...
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9f5f0; border-radius: 20px; overflow: hidden;">
            ...
            <div style="padding: 30px; background: white;">
                ...
                <p style="color: #555; line-height: 1.6;">
                    Gracias por formar parte de nuestra comunidad cafetera.
                    En Buitrón Coffee nos apasiona brindarte la mejor experiencia
                ...
                <a href="${process.env.FRONTEND_URL || 'http://localhost:5173'}/catalogo"
                   style="display: inline-block; background: #c0392b; color: white; padding: 12px 30px; text-decoration: none; border-radius: 30px; margin-top: 20px;">
                   Explorar productos →
                </a>
            </div>
            ...
            <div style="background: #2c3e50; padding: 20px; text-align: center;">
                <p style="color: #ecf0f1; margin: 0;">
                    © 2025 Buitrón Coffee - Calidad y tradición
                </p>
            </div>
        </div>
    `;
...
const enviarRecuperacionContrasena = async (email, nombre, codigo) => {
        ...
        <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 550px; margin: 0 auto; background: #f9f5f0; border-radius: 20px; overflow: hidden;">
            ...
            <div style="padding: 30px; background: white;">
                ...
                <div style="background: #fdf2e9; padding: 20px; border-radius: 12px; margin: 25px 0; text-align: center;">
                    <p style="margin: 0 0 10px; color: #2c3e50; font-weight: bold;">
                        Tu código de verificación es:
                    </p>

                    <p style="margin: 0; font-size: 32px; font-weight: bold; color: #c0392b; letter-spacing: 5px;">
                        ${codigo}
                    </p>
                </div>
                ...
                <p style="color: #888; font-size: 12px; text-align: center;">
                    Buitrón Coffee - Café de calidad para gente exigente
                </p>
            ...
            <div style="background: #2c3e50; padding: 15px; text-align: center;">
                <p style="color: #ecf0f1; margin: 0; font-size: 12px;">
                    © 2025 Buitrón Coffee - Todos los derechos reservados
                </p>
            </div>
    ...
    return enviarCorreo(
        email,
        nombre,
        "Recuperación de contraseña - Buitrón Coffee",
        html
    );
};
